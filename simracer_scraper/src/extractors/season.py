                ...
                for row in rows:
                    ...
                    for link in links:
                        ...
                        if match:
                            ...
                            # Try to extract race number, date and time from the row
                            # Race number is typically in first cell as "Race 1", "Race 2", etc.
                            ...
                            if cells:
                                ...
                                if race_num_match:
                                    race_dict["race_number"] = int(race_num_match.group(1))
                            for cell in cells:
